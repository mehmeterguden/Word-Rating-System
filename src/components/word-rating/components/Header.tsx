        ...
        <div className="bg-gradient-to-r from-slate-50 via-blue-50 to-indigo-50 border-b border-slate-200">
            <div className="max-w-7xl mx-auto px-6 py-4">
                <div className="flex items-center justify-between">
                    ...
                    {words.length > 0 && (
                        <div className="hidden md:block bg-gradient-to-r from-white/95 via-blue-50/90 to-indigo-50/90 backdrop-blur-sm rounded-2xl px-8 py-5 shadow-xl border border-white/60 relative overflow-hidden min-w-[600px]">
