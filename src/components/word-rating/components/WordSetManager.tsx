            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {wordSets.map((set) => (
                        <div
                            key={set.id}
                            className={`relative bg-gradient-to-br from-white via-blue-50/50 to-indigo-50/50 backdrop-blur-xl rounded-2xl shadow-xl border border-blue-200/50 p-6 transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] overflow-hidden ${set.id === activeSetId
                                    ...
                                    <div>
                                        <div className="flex items-center justify-between mb-4">
                                            <div className="flex items-center space-x-3">
                                                <div className={`w-3 h-3 rounded-full ${set.id === activeSetId ? 'bg-gradient-to-r from-blue-500 to-indigo-600' : 'bg-slate-300'
                                                    }`}></div>
