                ...
                <nav className="flex items-center justify-between py-2">
                    ...
                    <div className="flex space-x-1">
                        <button
                            ...
                            className={`px-6 py-4 text-sm font-medium transition-all duration-200 rounded-xl ${currentPage === 'home'
                        ...
                        <button
                            ...
                            className={`px-6 py-4 text-sm font-medium transition-all duration-200 rounded-xl ${currentPage === 'add'
                                    ? 'bg-gradient-to-r from-blue-500 to-indigo-500 text-white shadow-lg transform scale-105'
                                    : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50 hover:shadow-md'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-6 py-4 text-sm font-medium transition-all duration-200 rounded-xl ${currentPage === 'sets'
                                    ? 'bg-gradient-to-r from-blue-500 to-indigo-500 text-white shadow-lg transform scale-105'
                                    : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50 hover:shadow-md'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-6 py-4 text-sm font-medium transition-all duration-200 rounded-xl ${unevaluatedCount === 0
                        ...
                        <button
                            ...
                            className={`px-6 py-4 text-sm font-medium transition-all duration-200 rounded-xl ${evaluatedCount === 0
                                    ? 'bg-gray-200 text-gray-400 cursor-not-allowed'
                                    : currentPage === 'study'
                    ...
                    <div className="flex items-center space-x-4">
                        <button
                            ...
                            className={`px-6 py-4 text-sm font-medium transition-all duration-200 rounded-xl ${currentPage === 'settings'
                                    ? 'bg-gradient-to-r from-blue-500 to-indigo-500 text-white shadow-lg transform scale-105'
                                    : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50 hover:shadow-md'
                                }`}
                        >
                        ...
                        <button
                            onClick={() => onNavigate('text-selection-test')}
                            className={`px-6 py-4 text-sm font-medium transition-all duration-200 rounded-xl ${currentPage === 'text-selection-test'
                                    ...
                                    <div className="p-4">
                                        ...
                                        <div className="space-y-2 max-h-64 overflow-y-auto">
                                            {wordSets.map((set) => (
                                                <div
                                                    key={set.id}
                                                    className={`p-3 rounded-lg cursor-pointer transition-all duration-200 border-2 ${set.id === activeSetId
                                                ...
                                                >
                                                    <div className="flex items-center justify-between">
                                                        <div className="flex items-center space-x-3">
                                                            <div className={`w-3 h-3 rounded-full ${set.id === activeSetId
